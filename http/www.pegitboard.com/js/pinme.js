(function() {
	...
	var base_url = 'http://pegitboard.com/';
    ...
    if (window.location.href.match(/^(http|https):\/\/(pegitboard\.com)/))
	{
        alert('The PegMe Button has been successfully installed. You can now peg images from your favorite websites.');
        return false;
    }
	if(!document.scriptolutionRunning)
	{
		...
		if(imgs.length == 0)
		{
			alert('Unfortunately we were unable to locate any images big enough to be pegged.');
